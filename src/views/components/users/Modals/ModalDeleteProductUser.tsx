...
const ModalDeleteProductUser = () => {
  const isDeleteClosed = useUsersProductStore((state) => state.isDeleteClosed);
  const deleteProduct = useUsersProductStore((state) => state.deleteProduct);
...
export default ModalDeleteProductUser;
