...
const ModalAddProductUser = () => {
  const addProduct = useUsersProductStore((state) => state.addProduct);

  const isAddProducClosed = useUsersProductStore(
    (state) => state.isAddProducClosed,
  );
...
export default ModalAddProductUser;
